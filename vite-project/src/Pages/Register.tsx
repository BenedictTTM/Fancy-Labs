...
function Register() {
  ...
  return (
    <div className='flex min-h-screen'>
      {/* Left Panel */}
      <div className='bg-gradient-to-br from-teal-400 via-emerald-500 to-green-600 w-1/2 p-10 hidden md:block'>
      ...
      <div className='flex justify-center items-center bg-white w-full md:w-1/2'>
        <form onSubmit={handleSubmit} className='w-full max-w-md px-8 py-10'>
          <h2 className='text-3xl text-green-700 md:text-4xl mb-6 font-bold text-center'>
            Create Account
          </h2>
          ...
          <div className='space-y-5'>
            ...
            <div className='w-full flex justify-center mt-8'>
              <button
                type="submit"
                onClick={() => navigate('/login')}
                className='w-full max-w-xs bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-lg font-medium shadow hover:shadow-md transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]'
              >
                SIGN UP
              </button>
            </div>
